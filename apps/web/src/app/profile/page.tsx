        ...
        <div className="min-h-full px-4 sm:px-6 lg:px-8 py-6 space-y-6">
            ...
            <div id="overview" className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-300 text-sm mt-2">Connect socials and wallets to your profile.</p>
                </div>
            </div>
            ...
            <section
                id="socials"
                className="rounded-lg border border-gray-700 bg-gray-900/30 p-4 space-y-3 backdrop-blur-sm"
            >
                <div>
                    <h2 className="text-base font-semibold text-white">Social accounts</h2>
                    <p className="text-gray-300 text-xs mt-1">Verify your identity for giveaways and events.</p>
                </div>

                <div className="space-y-2">
                    {/* Discord */}
                    {discordUsername && (
                        <div className="flex items-center justify-between rounded border border-gray-700 bg-gray-800/50 px-4 py-3 hover:border-gray-600 transition">
                    ...
                    <div className="space-y-3">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300 text-sm">Switch to your wallet application</p>
                            </div>
                        </div>
...
function AlertModal({ type, title, message, icon, onConfirm, onCancel }: AlertModalProps) {
    ...
    return (
        <>
            ...
            {/* Modal */}
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div className="max-w-md w-full rounded-lg border border-gray-700 bg-gray-900/90 backdrop-blur-sm p-6 space-y-6">
                    {/* Icon */}
                    {icon && (
