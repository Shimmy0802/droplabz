        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6 flex flex-col sm:flex-row gap-4">
                    <div className="flex-1">
                        <input
                            ...
                            className="w-full px-4 py-3 bg-[#111528] border border-[rgba(0,255,65,0.2)] rounded text-white placeholder-gray-500 focus:outline-none focus:border-[#00ff41] transition"
                        />
                    </div>
                    <div>
                        <select
                            ...
                            className="px-4 py-3 bg-[#111528] border border-[rgba(0,255,65,0.2)] rounded text-white focus:outline-none focus:border-[#00ff41] transition"
                        >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                    <div className="bg-[#111528] border border-[rgba(0,255,65,0.1)] rounded p-4">
                        <p className="text-gray-400 text-sm">Total Users</p>
                        <p className="text-2xl font-bold text-white mt-2">{users.length}</p>
                    </div>
                    <div className="bg-[#111528] border border-[rgba(0,255,65,0.1)] rounded p-4">
                        <p className="text-gray-400 text-sm">Super Admins</p>
                        <p className="text-2xl font-bold text-[#00ff41] mt-2">
                            {users.filter(u => u.role === 'SUPER_ADMIN').length}
                        </p>
                    </div>
                    <div className="bg-[#111528] border border-[rgba(0,212,255,0.1)] rounded p-4">
                        <p className="text-gray-400 text-sm">Admins</p>
                        <p className="text-2xl font-bold text-[#00d4ff] mt-2">
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-[rgba(0,255,65,0.05)]">
                                    {filteredUsers.map(user => (
                                        <tr key={user.id} className="hover:bg-[rgba(0,255,65,0.03)] transition">
                                                ...
                                                {editingUserId === user.id ? (
                                                    <div className="flex items-center gap-2">
                                                        <select
                                                            ...
                                                            className="px-2 py-1 bg-[#111528] border border-[rgba(0,255,65,0.2)] rounded text-white text-xs focus:outline-none focus:border-[#00ff41] transition"
                                                        >
                                                            <option value="SUPER_ADMIN">Super Admin</option>
                                                            <option value="ADMIN">Admin</option>
                                                            <option value="MEMBER">Member</option>
                                                        ...
                                                        <button
                                                            ...
                                                            className="px-2 py-1 bg-[#00ff41] text-[#0a0e27] rounded text-xs font-semibold hover:bg-[#00dd33] transition"
                                                        >
                                                            Save
                                                        </button>
                                                        <button
